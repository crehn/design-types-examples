...
public class ResidualLifeExpectancySmokingTest extends AbstractResidualLifeExpectancyTest {
	...
	public void shouldGetForNonSmoker() {
		givenInsuree(FIFTY_YEAR_OLD_MALE.smokingHabit(NON_SMOKER).build());
	...
	public void shouldGetForPersonWhoStoppedSmoking() {
		givenInsuree(FIFTY_YEAR_OLD_MALE.smokingHabit(STOPPED_SMOKING).build());
	...
	public void shouldGetForSmokerWith5CigarettesPerDay() {
		givenInsuree(FIFTY_YEAR_OLD_MALE.smokingHabit(LESS_THAN_5_CIGARETTES_PER_DAY).build());
	...
	public void shouldGetForSmokerWith20CigarettesPerDay() {
		givenInsuree(FIFTY_YEAR_OLD_MALE.smokingHabit(LESS_THAN_20_CIGARETTES_PER_DAY).build());
	...
	public void shouldGetForSmokerWithMoreThan20CigarettesPerDay() {
		givenInsuree(FIFTY_YEAR_OLD_MALE.smokingHabit(MORE_THAN_20_CIGARETTES_PER_DAY).build());
